...
-- 导出 mhzqx 的数据库结构
CREATE DATABASE IF NOT EXISTS `food` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `food`;
...
INSERT INTO `customer` (`CUSID`, `OPENID`, `NICKNAME`) VALUES
	('b05e4214-cdfe-4e85-b82c-54a5a4eefcc8', 'o4VLO5YDw9U3HwPwQRQUUz9QvTHk', 'emper0r');
...
INSERT INTO `syscus` (`CUSID`, `NICKNAME`, `LIMITS`) VALUES
	('b05e4214-cdfe-4e85-b82c-54a5a4eefcc8', 'emper0r', 'true');
